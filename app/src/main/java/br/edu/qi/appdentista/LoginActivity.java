    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(edtUsuarioLogin.equals("admin") && (edtSenhaLogin.equals("123"))){
                    objLogin.setUsuario(edtUsuarioLogin.getText().toString());
                    objLogin.setSenha(Integer.parseInt(edtSenhaLogin.getText().toString()));
